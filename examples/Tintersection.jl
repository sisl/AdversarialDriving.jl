...
sut_agent = BlinkerVehicleAgent(up_left(id=1, s=35., v=15.), TIDM(Tint_TIDM_template, noisy_observations = true))
adv1 = BlinkerVehicleAgent(left_straight(id=2, s=26., v=15.0), TIDM(Tint_TIDM_template))
adv2 = BlinkerVehicleAgent(left_turnright(id=3, s=36., v=15.0), TIDM(Tint_TIDM_template))
...
s = initialstate(mdp)
cam = StaticCamera(position=(0,-10), zoom=17.)
