...
loss(p) = maml_task_batch_loss(p, gen_ADM_sampler(dt = 0.18, T=13), N_tasks, N_eps_train, N_eps_test, inner_lr, 0.95, 1., first_order = true, store_log = true, logger = training_log)
